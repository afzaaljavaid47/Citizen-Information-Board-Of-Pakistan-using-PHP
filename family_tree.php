...
<div class="main-top">
			...
			<a class="navbar-brand" href="index.html" style="font-weight: bold;color: #0c118a">CIBOP</a>	<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-wd" aria-controls="navbar-wd" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
						...
						<li><a class="nav-link active" href="family_tree.php">Family Tree</a></li>
	...
	<div class="container">
        ...
        <div class="col-md-3"></div>
			...
			<p style="text-align: center;"><span class="text-danger"><br>Important !&nbsp;&nbsp;</span>CNIC Number will be Without Dashes</p>
			</form>
			</div>
			<div class="col-md-3"></div>			
			</div>
			...
			<center>
				<?php
                    ...
                    if(isset($_POST['search']))
                    {
                    	$search=$_POST['cnic'];
                    ?>
                    <h2>Result Against Father CNIC No. <b><u><?php echo $search;?></u></b></h2>
			<table class="table table-responsive table-striped table-hover table-condensed col-md-12">
				<thead>
				<tr class="table-primary">
					  <td style="font-size: 19px;">Father Name</td>
			          <td colspan="2" style="font-size: 19px;">Father CNIC</td>
			          <td style="font-size: 19px;">Mother Name</td>
			          <td colspan="2" style="font-size: 19px;">Mother CNIC</td>
				...
				<tbody>
					<?php
                    $sql="SELECT * FROM `family_tree_parents_info` WHERE `father_cnic`='$search'";
                    ...
                    while($data=mysqli_fetch_assoc($run))
                    {
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-center"><?php echo $data['father_cnic'];?></td>
                            <td class="text-center"><?php echo $data['mother_name'];?></td>
                            <td colspan="2" class="text-center"><?php echo $data['mother_cnic'];?></td>
