	...
	<div class="container">
        ...
        <div class="col-md-3"></div>
			...
			<form method="post" class="form-inline">
				...
				<center><span class="text-danger"><br>Important !&nbsp;&nbsp;&nbsp;</span>Info in the form of Cell, Home and Work Phone Number</center>
			</form>
			</div>
			<div class="col-md-3"></div>			
			</div>
			...
			<center>
				<?php
                    ...
                    if(isset($_POST['search']))
                    {
                    	$search=$_POST['tofind'];
                    ?>
                    <h2>Result Against Number Info : <b><u><?php echo $search;?></u></b></h2>
			<table class="table table-responsive table-striped table-hover table-condensed">
				<thead>
				<tr class="table-primary">
					<td style="font-size: 19px;">Name</td>
					<td style="font-size: 19px;">CNIC</td>
					<td style="font-size: 19px;">Home Phone</td>
					<td style="font-size: 19px;">Work Phone</td>
					<td style="font-size: 19px;">Cell Phone</td>
					<td style="font-size: 19px;">State</td>					
				...
				<tbody>
					<?php
                    $sql="SELECT * FROM `phone_book` WHERE `home_phone` LIKE '%$search%' || `work_phone` LIKE '%$search%' || `cell_phone` LIKE '%$search%' ";
                    	...
                    	while($data=mysqli_fetch_assoc($run))
                    {
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $data['home_phone'];?></td>
                            <td class="text-center"><?php echo $data['work_phone'];?></td>
                            <td class="text-center"><?php echo $data['cell_phone'];?></td>
                            <td class="text-center"><?php echo $data['state'];?></td>
                            <td class="text-center"><?php echo $data['city'];?></td>
                            <td class="text-center"><?php echo $data['address'];?></td>
                            <td><a href="phone_info.php?id=<?php  echo $data['cnic'];?>" class="btn btn-primary">View</a></td>
                        </tr>
