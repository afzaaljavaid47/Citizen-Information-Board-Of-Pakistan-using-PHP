...
include("dbcon.php");
$id=$_GET['id'];
$sql="SELECT * FROM `court_record` WHERE `p_cnic`='$id'";
...
<div class="main-top">
	...
	<header class="top-header" style="border-bottom: 1px solid black">
		<nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
			<a class="navbar-brand" href="index.html" style="font-weight: bold;color: #0c118a">CIBOP</a>
...
<table border="2" class="table-striped table-hover">
	<tr>
		...
		<td style="padding: 50px;">
			<table>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Case No. </b></span></td>
					<td><?php echo $data['case_no'];?></td>
				</tr>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Court Address  </b></span></td>
					<td><?php echo $data['court_address'];?></td>
				</tr>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Lawyer</b></span></td>
                ...
                <tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Opposition Name </b></span></td>
					<td><?php echo $data['opp_name'];?></td>
				</tr>
				
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Opposition CNIC </b></span></td>
					<td><?php echo $data['opp_cnic'];?></td>
				</tr>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Opposition Mobile No. </b></span></td>
					<td><?php echo $data['omobile'];?></td>
				</tr>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Opposition Gender  </b></span></td>
					<td><?php echo $data['opp_gender'];?></td>
				</tr>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Opposition Address</b></span></td>
					<td><?php echo $data['opp_address'];?></td>
				</tr>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Alligation </b></span></td>
