			...
			<a class="navbar-brand" href="index.html" style="font-weight: bold;color: #0c118a">CIBOP</a>	<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-wd" aria-controls="navbar-wd" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link active" href="criminal_search.php">Criminal Record</a></li>
        ...
        <div class="col-md-3"></div>
			...
			<form method="post" class="form-inline">
				<div class="form-group">
					<label>Enter Criminal Info : &nbsp;&nbsp; </label>
			...
			<table class="table table-responsive table-striped table-hover table-condensed">
				...
				<tr class="table-primary">
					...
					<td style="font-size: 19px;">Case</td>
					<td style="font-size: 19px;">Case Date</td>
					<td style="font-size: 19px;">Police Station</td>
					<td style="font-size: 19px;">Criminal Status</td>
				...
				<tbody>
					<?php
                    $sql="SELECT * FROM `criminal_record` WHERE `cnic` LIKE '%$search%' || `name` LIKE '%$search%' || `age` LIKE '%$search%' || `address` LIKE '%$search%' || `mobile_no` LIKE '%$search%'";
                    ...
                    while($data=mysqli_fetch_assoc($run))
                    {
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $data['cnic'];?></td>
                            <td class="text-center"><?php echo $data['age'];?></td>
                            <td class="text-center"><?php echo $data['address'];?></td>
                            <td class="text-center"><?php echo $data['jurm'];?></td>
                            <td class="text-center"><?php echo $data['case_date'];?></td>
                            <td class="text-center"><?php echo $data['station'];?></td>
                            <td class="text-center"><?php echo $data['criminal_status'];?></td>
                            <td class="text-center"><img src="admin/upload_criminal_images/<?php echo $data['photo'];?>" style="width: 100px;height: 100px;border-radius: 50px;"></td>
                            <td><a href="criminal_info.php?id=<?php  echo $data['cnic'];?>" class="btn btn-primary">View</a></td>
                        </tr>
                                           <?php
                    }
                    }
