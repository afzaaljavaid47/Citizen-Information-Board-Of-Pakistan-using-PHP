      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item active">
            <a class="nav-link active" href="total_subscribers.php">
    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Total Subscribers</h1>
            <br>
      ...
      <table class="table table-responsive table-condensed">
        ...
        <tr">
          ...
          <td style="font-size: 19px;">Subscribe Date</td>
        </tr>
        </thead>
        <tbody>
          <?php
