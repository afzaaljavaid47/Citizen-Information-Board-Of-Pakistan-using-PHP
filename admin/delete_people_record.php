        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              ...
              <a href="delete_people_record.php" class="dropdown-item active"><i class="fas fa-trash-alt"></i>Delete Record</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Delete People Record </h1>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="gender" class="form-control" readonly="" value="<?php echo $data['gender'];?>">
                </div>
                <div class="form-group">
                  <label>Age</label>
                  <input type="number" value="18" name="age" class="form-control" readonly="" value="<?php echo $data['age'];?>">
                </div>
                <div class="form-group">
                  <label>City</label>
                  <input type="text" name="city" class="form-control" readonly="" value="<?php echo $data['city'];?>">
                </div>                          
              </div>
              <div class="col-md-3">
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="mobile" class="form-control" readonly="" value="<?php echo $data['mobile_number'];?>">
                </div>
                <div class="form-group">
                  <label>Temporary Address</label>
                  <input type="text" name="taddress" readonly="" class="form-control" value="<?php echo $data['temporary_address'];?>">
                </div>
                <div class="form-group">
                  <label>Photo</label>
                  <img src="upload_images/<?php echo $data['photo'];?>" id="logo_preview" style="width: 200px;height: 150px;">
                </div>
                </div>
              <div class="col-md-3">
                <div class="form-group">
                  <label>CNIC</label>
                  <input type="text" name="cnic" readonly="" class="form-control" value="<?php echo $data['person_cnic'];?>">
                </div>
                <div class="form-group">
                  <label>Person E-Mail</label>
                  <input type="email" name="email" readonly="" class="form-control" value="<?php echo $data['email'];?>">
                </div>
                <div class="form-group">
                  <label>Permanenet Address</label>
                  <input type="text" name="paddress" readonly="" class="form-control" value="<?php echo $data['permanent_address'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea name="er" class="form-control" readonly=""><?php echo $data['extra_remarks'];?></textarea>
                </div>
              </div>
              <div class="col-md-2"></div>
            </div>
...
{
  $cnic=$_POST['cnic'];
  $sql_fetch_cnic="DELETE FROM `people_record` WHERE `person_cnic`='$cnic'";
  $run=mysqli_query($con,$sql_fetch_cnic);
  if($run)
  {
    ?>
