    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding-top: 20px;color: white;">Total Messages</h1>
            <p style="text-align: center;font-weight: bold;color: wheat">Please Check your inbox to reply to users</p>
            <br>
      ...
      <table class="table table-responsive table-condensed">
        ...
        <tr>
          ...
          <td style="font-size: 19px;">Message</td>
          <td style="font-size: 19px;">Message Date</td>
        </tr>
        </thead>
        <tbody>
          <?php
