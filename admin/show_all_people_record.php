        ...
        <div class="navbar-collapse-header d-md-none">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              ...
              <a href="show_all_people_record.php" class="dropdown-item active"><i class="fas fa-globe-asia"></i>Show all Record</a>
            </div>
          </li>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">All People Record Details</h1>
            <br>
