      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Update People Record </h1>
            <div class="row">
  ...
  while($data=mysqli_fetch_assoc($run))
    {
      ...
      <h3 style="text-align: center;color: white">You can update only some fields</h3>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="mobile" class="form-control" value="<?php echo $data['mobile_number'];?>">
                </div>
                <div class="form-group">
                  <label>Temporary Address</label>
                  <input type="text" name="taddress" class="form-control" value="<?php echo $data['temporary_address'];?>">
                </div>
                <div class="form-group">
                  <label>Photo</label>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="paddress" class="form-control" value="<?php echo $data['permanent_address'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea name="er" class="form-control"><?php echo $data['extra_remarks'];?></textarea>
                </div>
              </div>
              <div class="col-md-2"></div>
            </div>
...
if(isset($_POST['submit_update']))
{
  ...
  $er=$_POST['er'];
  $mobile=$_POST['mobile'];
  $sql_fetch_cnic="UPDATE `people_record` SET `name`='$name',`father_name`='$fname',`mobile_number`='$mobile',`age`='$age',`email`='$email',`city`='$city',`temporary_address`='$taddress',`permanent_address`='$paddress',`identity_mark`='$im',`extra_remarks`='$er' WHERE `person_cnic`='$cnic'";
  $run=mysqli_query($con,$sql_fetch_cnic);
  if($run)
  {
    ?>
