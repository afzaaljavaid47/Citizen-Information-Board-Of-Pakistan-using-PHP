        ...
        <div class="navbar-collapse-header d-md-none">
          ...
          <li class="nav-item dropdown active">
           ...
           <div class="dropdown-menu">
              ...
              <a href="delete_court_record.php" class="dropdown-item active"><i class="fas fa-trash-alt"></i>Delete Record</a>
    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Delete Court Record </h1>
            <div class="row">
          ...
          <form method="post" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label>Case No.</label>
                  <input type="number" name="cn" class="form-control" value="<?php echo $data['case_no'];?>">
                </div>
                <div class="form-group">
                  <label>Name</label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="" class="form-control" value="<?php echo $data['p_gender'];?>">
                 </div>
                 <div class="form-group">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" name="ca" class="form-control" value="<?php echo $data['court_address'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="paddress" class="form-control" value="<?php echo $data['p_address'];?>">
                </div>
                <div class="form-group">
                  <label>Opposition Gender</label><br>
                  <input type="text" class="form-control" name="" value="<?php echo $data['opp_gender'];?>">
                </div>
                <div class="form-group">
                  <label>Opposition CNIC</label>
                 <input type="text" name="ocnic" class="form-control" value="<?php echo $data['opp_cnic'];?>">
                </div>                               
                </div>
              <div class="col-md-3">
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>CNIC</label>
                  <input type="text" name="cnic" class="form-control" value="<?php echo $data['p_cnic'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="oa" class="form-control" value="<?php echo $data['opp_address'];?>">
                </div>
                 <div class="form-group">
...
{
  $cnic=$_POST['cnic'];
  $sql_fetch_cnic="DELETE FROM `court_record` WHERE `p_cnic`='$cnic'";
  $run=mysqli_query($con,$sql_fetch_cnic);
  if($run)
  {
    ?>
