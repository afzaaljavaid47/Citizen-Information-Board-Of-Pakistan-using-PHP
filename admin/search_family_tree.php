        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              ...
              <a href="search_family_tree.php" class="dropdown-item active"><i class="fas fa-search"></i>Search Record</a>
    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Search Family Record </h1>
            <div class="row">
  ...
  while($data=mysqli_fetch_assoc($run))
    {
      ...
      <h2 style="color: white;text-align: center;">Parents Info</h2>
      <hr>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="fname" readonly="" class="form-control" value="<?php echo $data['father_name'];?>">
                </div>
                <div class="form-group">
                  <label>Father CNIC No. (Without Dashes)</label>
                  <input type="text" name="fcnic" readonly="" class="form-control" value="<?php echo $data['father_cnic'];?>">
                </div>
                <div class="form-group">
                  <label>Father D.O.B </label>
                  <input type="date" name="fdob" readonly="" class="form-control" value="<?php echo $data['father_dob'];?>">
                </div>
                <div class="form-group">
                  <label>Fater Died Date (If Father Died)</label>
                  <input type="date" name="fdd" readonly="" class="form-control" value="<?php echo $data['father_dd'];?>">
                </div>  
                <div class="form-group">
                  <label>Family Address</label>
                  <input type="text" name="faddress" readonly="" class="form-control" value="<?php echo $data['family_address'];?>">
                </div>  
                </div>
              <div class="col-md-1"></div>
              ...
              <div class="col-md-4">
                  ...
                  <input type="text" name="mname" readonly="" class="form-control" value="<?php echo $data['mother_name'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="mdob" readonly="" class="form-control" value="<?php echo $data['mother_dob'];?>">
                </div>
                <div class="form-group">
                  <label>Mother Died Date (If Father Died)</label>
                  <input type="date" name="mdd" readonly="" class="form-control" placeholder="Sialkot....." value="<?php echo $data['mother_ddd'];?>">
                </div>
                            </div>
              <div class="col-md-2"></div>
            </div>
