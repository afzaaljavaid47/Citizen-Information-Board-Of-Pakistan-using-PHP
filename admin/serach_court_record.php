        ...
        <div class="navbar-collapse-header d-md-none">
          ...
          <li class="nav-item dropdown active">
           ...
           <div class="dropdown-menu">
              ...
              <a href="serach_court_record.php" class="dropdown-item active"><i class="fas fa-search"></i>Search Record</a>
...
<h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Search Court Record </h1>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="" readonly="" class="form-control" value="<?php echo $data['p_gender'];?>">
                 </div>
                 <div class="form-group">
                  <label>Opposition Name</label>
                  <input type="text" name="oname" readonly="" class="form-control" value="<?php echo $data['opp_name'];?>">
                </div>
                <div class="form-group">
                  <label>Opposition Mobile No.</label>
                  <input type="text" name="omobile" readonly="" class="form-control" value="<?php echo $data['omobile'];?>">
                </div>                              
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  <label>Court Address</label>
                  <input type="text" name="ca" readonly="" class="form-control" value="<?php echo $data['court_address'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="paddress" readonly="" class="form-control" value="<?php echo $data['p_address'];?>">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label>Lawyer</label>
                  <input type="text" name="lawyer" readonly="" class="form-control" value="<?php echo $data['lawyer'];?>">
                </div>
                <div class="form-group">
                  <label>CNIC</label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="pmobile" readonly="" class="form-control" value="<?php echo $data['pmobile'];?>">
                </div>
                <div class="form-group">
                  <label>Opposition Address</label>
                  <input type="text" name="oa" readonly="" class="form-control" value="<?php echo $data['opp_address'];?>">
                </div>
                 <div class="form-group">
                  <label>Alligation</label>
                  <textarea name="al" readonly="" class="form-control"><?php echo $data['alligation'];?></textarea>
                </div>                
              </div>
              <div class="col-md-2"></div>
            </div>
