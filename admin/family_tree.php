      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              <a href="family_tree.php" class="dropdown-item active"><i class="fas fa-plus"></i>Add Record</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
          	<h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Add a Family Record</h1>
             <h1 style="color: white;padding-left: 90px;">Parents Info</h1>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="mcnic" class="form-control" required="">
                </div>
                <div class="form-group">
                  <label>Mother D.O.B </label>
                  <input type="date" name="mdob" class="form-control" required="">
                </div>
                <div class="form-group">
                  <label>Mother Died Date (If Father Died)</label>
                  <input type="date" name="mdd" class="form-control" placeholder="Sialkot.....">
                </div>
                            </div>
      ...
      <div class="input_field">
        <table class="table table-bordered" id="table_field">
          <tr>
            ...
            <th class="text-center" style="font-size: 18px;">Add or Remove</th>
          </tr>
          <tr>
            <td><input type="text" name="name[]" class="form-control" required=""></td>
            <td><input type="date" name="dob[]" class="form-control" required=""></td>
            <td><input type="date" name="dod[]" class="form-control"></td>
            <td><input type="text" name="cnic[]" class="form-control" required=""></td>
            <td><input type="button" name="add" value="Add" id="add" class="btn btn-primary"></td>
          </tr>
        </table>
        <center><br>
         <div class="form-group">
        <input type="submit" class="btn btn-lg btn-lg btn-primary" name="submit_child" value="Submit Record" style="font-size: 18px;">
        </div>
          </center>
      </div>
      </div>
...
if(isset($_POST['submit_child']))
{
  ...
  $sql_query="INSERT INTO `family_tree_parents_info`(`father_name`, `father_cnic`, `father_dob`, `father_dd`, `mother_name`, `mother_cnic`, `mother_dob`, `mother_ddd`, `family_address`) VALUES ('$fname','$fcnic','$fdob','$fdd','$mname','$mcnic','$mdob','$mdd','$faddress')";
  ...
  {
    $sql="INSERT INTO `family_tree_childs_info`(`name`, `dob`, `dd`, `cnic`,`father_cnic`) VALUES ('".$value."','".$dob[$key]."','".$dod[$key]."','".$cnic[$key]."','".$fcnic."')";
  ...
  if($run)
  {
    ?>
   <script type="text/javascript">
      alert("Family Record Addredd Successfully !");
    </script>
<?php
  }
  else
