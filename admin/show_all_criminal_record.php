    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">All Criminal Record Details</h1>
            <br>
      ...
      <table class="table table-responsive table-condensed">
        ...
        <tr">
          ...
          <td style="font-size: 19px;">Case Status</td>
          ...
          <?php
                    ...
                    while($data=mysqli_fetch_assoc($run))
                    {
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $data['case_status'];?></td>
