        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              ...
              <a href="delete_criminal_record.php" class="dropdown-item active"><i class="fas fa-trash-alt"></i>Delete Record</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Delete Criminal Record </h1>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                 ...
                 <input type="text" name="" class="form-control" readonly="" value="<?php echo $data['gender'];?>"> 
                </div>
                <div class="form-group">
                  <label>Age</label>
                  <input type="number" value="18" name="age" readonly="" class="form-control" value="<?php echo $data['age'];?>">
                </div>
                <div class="form-group">
                  <label>Police Station</label>
                  <input type="text" name="ps" class="form-control" readonly="" placeholder="Enter Police Station Name....." value="<?php echo $data['station'];?>">
                </div>
                 <div class="form-group">
                  <label>Criminal Status</label>
                  <input type="text" name="" class="form-control" value="<?php echo $data['criminal_status'];?>">
                  </div>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  <label>Case</label>
                  <input type="text" name="case" class="form-control" readonly="" value="<?php echo $data['case_status'];?>">
                </div>
               <div class="form-group">
                  <label>Photo</label>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="paddress" readonly="" class="form-control" value="<?php echo $data['address'];?>">
                </div>
                <div class="form-group">
                  <label>Case Date</label>
                  <input type="date" name="cd" class="form-control" readonly="" value="<?php echo $data['case_date'];?>">
                </div>
                <div class="form-group">
                  <label> Criminal Identity Mark</label>
                  <input type="text" name="im" class="form-control" readonly="" value="<?php echo $data['identity_mark'];?>">
                </div>
                <div class="form-group">
...
{
  $cnic=$_POST['cnic'];
  $sql_fetch_cnic="DELETE FROM `criminal_record` WHERE `cnic`='$cnic'";
  $run=mysqli_query($con,$sql_fetch_cnic);
  if($run)
  {
    ?>
