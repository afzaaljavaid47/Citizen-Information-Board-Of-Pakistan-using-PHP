      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              <a href="phone_book.php" class="dropdown-item active"><i class="fas fa-plus"></i>Add Record</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
          	<h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Phone Book Details</h1>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="zip" class="form-control" required="" placeholder="51420.....">
                </div>                           
              </div>
              ...
              <div class="col-md-4">
                  ...
                  <input type="text" name="cnic" class="form-control" required="" placeholder="3460272108214">
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                  <label>Address</label>
                  <input type="text" name="address" class="form-control" required="" placeholder="Permanent address Here.....">
                </div>
                <div class="form-group">
...
if(isset($_POST['submit']))
{
  ...
  $zip=$_POST['zip'];
  $fax=$_POST['fax'];
  $sql_fetch_cnic="SELECT * FROM `phone_book` WHERE `home_phone`='$hphone' || `work_phone`='$wphone' || `cell_phone`='$cphone'";
  $run=mysqli_query($con,$sql_fetch_cnic);
  if(mysqli_num_rows($run)>0)
  {
    ?>
   <script type="text/javascript">
      alert("Info Already Exist !");
    </script>
   <?php
  }
  else if($hphone==$wphone||$wphone==$cphone||$cphone==$hphone)
  {
   ?>
   <script type="text/javascript">
      alert("Cell Phone , Mobile Phone and Work Phone Should not be same !");
    </script>
   <?php 
  }
  else
  {
  $sql="INSERT INTO `phone_book`(`name`, `cnic`, `home_phone`, `work_phone`, `cell_phone`, `fax`, `state`, `city`, `zipcode`, `address`, `gender`) VALUES ('$name','$cnic','$hphone','$wphone','$cphone','$fax','$state','$city','$zip','$address','$gender')";
  $run=mysqli_query($con,$sql);
  if($run)
  {
    ?>
