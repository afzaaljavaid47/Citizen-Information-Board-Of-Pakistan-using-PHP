      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav mb-md-3">
          ...
          <li class="nav-item active">
            <a class="nav-link active" href="user_feedbacks.php">
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding-top: 20px;color: white;">Total FeedBacks</h1>
            <br>
      <center style="background-color: rgba(0,0,0,0.5);">
      <table class="table table-responsive table-condensed">
        <thead>
        <tr">
          <td style="font-size: 19px;">ID</td>
          <td style="font-size: 19px;">E-Mail</td>
          <td style="font-size: 19px;">FeedBack</td>
          <td style="font-size: 19px;">FeedBack Date & Time</td>
        </tr>
        </thead>
        <tbody>
          <?php
                    ...
                    while($data=mysqli_fetch_assoc($run))
                    {
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $data['feedback_date'];?></td>
                        </tr>
                        <?php
                    }
                  }
