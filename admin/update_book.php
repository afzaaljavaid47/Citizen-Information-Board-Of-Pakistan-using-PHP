        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              ...
              <a href="update_book.php" class="dropdown-item active"><i class="fas fa-edit"></i>Update Record</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Update Phone Book</h1><div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="cphone" readonly="" class="form-control" value="<?php echo $data['cell_phone'];?>">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  <label>State</label>
                    <input type="text" name="" readonly="" class="form-control" value="<?php echo $data['state'];?>">
                </div>
                <div class="form-group">
                  <label>Address</label>
...
if(isset($_POST['submit_update']))
{
  ...
  $sql_fetch_cnic="UPDATE `phone_book` SET `name`='$name',`home_phone`='$hphone',`work_phone`='$wphone',`fax`='$fax',`city`='$city',`zipcode`='$zip',`address`='$address' WHERE `cell_phone`='$cphone'";
  $run=mysqli_query($con,$sql_fetch_cnic);
  if($run)
  {
    ?>
