        ...
        <div class="navbar-collapse-header d-md-none">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              ...
              <a href="update_criminal_record.php" class="dropdown-item active"><i class="fas fa-edit"></i>Update Record</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Update Criminal Record </h1>
            <div class="row">
  ...
  while($data=mysqli_fetch_assoc($run))
    {
      ?>
      <hr>
      <h2 style="color: white;text-align: center;">Record Against CNIC No. <b><u style="color: wheat;letter-spacing: 2px;"><?php echo $cnic;?></u></b></h2> <h3 style="text-align: center;color: white">You can update only some fields</h3>
<hr>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="ps" class="form-control" value="<?php echo $data['station'];?>">
                </div>
                 <div class="form-group">
                  <label>Criminal Status</label>
                  <input type="text" name="cs" class="form-control" value="<?php echo $data['criminal_status'];?>">
                  </div>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="mobile" class="form-control" value="<?php echo $data['mobile_no'];?>">
                </div>
                <div class="form-group">
                  <label>Case</label>
                  <input type="text" name="case" class="form-control" value="<?php echo $data['case_status'];?>">
                </div>
               <div class="form-group">
                  <label>Photo</label>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="cd" class="form-control" value="<?php echo $data['case_date'];?>">
                </div>
                <div class="form-group">
                  <label> Criminal Identity Mark</label>
                  <input type="text" name="im" class="form-control" value="<?php echo $data['identity_mark'];?>">
                </div>
                <div class="form-group">
                  <label>Case Current Status</label>
                  <textarea name="ccs" class="form-control"><?php echo $data['case_status'];?></textarea>
                </div>
              </div>
              <div class="col-md-2"></div>
            </div>
...
if(isset($_POST['submit_update']))
{
  ...
  $sql_fetch_cnic="UPDATE `criminal_record` SET `name`='$name',`father_name`='$fname',`mobile_no`='$mobile',`address`='$address',`age`='$age',`jurm`='$case',`case_date`='$case_date',`station`='$station',`identity_mark`='$im',`criminal_status`='$cs',`case_status`='$ccs' WHERE `cnic`='$cnic'";
  $run=mysqli_query($con,$sql_fetch_cnic);
  if($run)
  {
    ?>
