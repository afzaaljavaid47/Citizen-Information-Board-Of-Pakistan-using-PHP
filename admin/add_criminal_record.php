      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              <a href="add_criminal_record.php" class="dropdown-item active"><i class="fas fa-plus"></i>Add Record</a>
              <a href="delete_criminal_record.php" class="dropdown-item"><i class="fas fa-edit"></i>Delete Record</a>
              <a href="update_criminal_record.php" class="dropdown-item"><i class="fas fa-trash-alt"></i>Update Record</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Criminal Record Details</h1>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="ps" class="form-control" placeholder="Enter Police Station Name.....">
                </div>
                 <div class="form-group">
                  <label>Criminal Status</label>
                  <select name="cs" class="form-control">
                    <option>---Select Criminal Status---</option>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  <label>Case</label>
                  <input type="text" name="case" class="form-control" placeholder="Enter Case.....">
                </div>

              <div class="form-group">
                  <label>Browse Criminal Photo</label>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="cd" class="form-control" placeholder="Enter Police Station Name.....">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea name="ccs" class="form-control"></textarea>
                </div>
              </div>
...
if(isset($_POST['submit']))
{
  ...
  move_uploaded_file($tempname,"upload_criminal_images/$imagename");
  $sql="INSERT INTO `criminal_record`(`name`, `father_name`, `cnic`, `gender`, `mobile_no`, `address`, `age`, `jurm`, `case_date`, `station`, `photo`, `identity_mark`, `criminal_status`, `case_status`) VALUES ('$name','$fname','$cnic','$gender','$mobile','$address','$age','$case','$cd','$ps','$imagename','$im','$cs','$ccs')";
  $run=mysqli_query($con,$sql);
  if($run)
  {
    ?>
