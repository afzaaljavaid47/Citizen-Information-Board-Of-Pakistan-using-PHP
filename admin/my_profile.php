    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
        <div class="header-body">          
          ...
          <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">User Profile </h1>
            <div class="row">
              <div class="col-md-2"></div>
              <div class="col-md-8">
                <form method="POST">
                  <div class="form-group">
                    <label>user Name<span class="text-danger"> (You can not change your User Name)</span></label>
                    <input type="text" name="" class="form-control" readonly="" value="<?php  echo $data['user_name']; ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="secret_passowrd" class="form-control" value="<?php  echo $data['secret_passowrd']; ?>">
                  </div>
                  <div class="form-group">
                    <input type="submit" name="submit" value="Update Profile" class="btn btn-primary btn-block" style="font-size: 18px;letter-spacing: 2px;">
                  </div>
                </form>
              </div>
              <div class="col-md-2"></div>
...
{
  $pass=$_POST['password'];
  $sec_pass=$_POST['secret_passowrd'];
  $sql_query="UPDATE `admins` SET `password`='$pass',`secret_passowrd`='$sec_pass' WHERE `id`='$un_id'";
