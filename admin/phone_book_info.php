...
$id=$_GET['id'];
$sql1="SELECT * FROM `phone_book` WHERE `cell_phone`='$id'";
  ...
  <tr>
    <td style="padding: 50px;">
      <table>
        ...
        <tr>
          <td style="padding: 10px;"><span style="font-size: 18px;">  <b>Cell Phone </b></span></td>
          <td><?php echo $data['cell_phone'];?></td>
        </tr>
        <tr>
          <td style="padding: 10px;"><span style="font-size: 18px;">  <b>Home Phone</b></span></td>
          <td><?php echo $data['home_phone'];?></td>
        </tr>
        <tr>
          <td style="padding: 10px;"><span style="font-size: 18px;">  <b>Work Phone</b></span></td>
          <td><?php echo $data['work_phone'];?></td>
        </tr>
         <tr>
          <td style="padding: 10px;"><span style="font-size: 18px;">  <b>Fax </b></span></td>
