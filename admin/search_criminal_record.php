        ...
        <div class="navbar-collapse-header d-md-none">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              ...
              <a href="search_criminal_record.php" class="dropdown-item active"><i class="fas fa-search"></i>Search Record</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Search Criminal Record </h1>
            <div class="row">
...
{
  $cnic=$_POST['search'];
  $sql_fetch_cnic="SELECT * FROM `criminal_record` WHERE `cnic`='$cnic'";
          ...
          <form method="post" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" name="name"  readonly="" class="form-control" value="<?php echo $data['name'];?>">
                </div>
                <div class="form-group">
                  <label>Gender</label><br>
                 <input type="text" name="" readonly="" class="form-control" value="<?php echo $data['gender'];?>"> 
                </div>
                <div class="form-group">
                  <label>Age</label>
                  <input type="number" name="age" readonly="" class="form-control" value="<?php echo $data['age'];?>">
                </div>
                <div class="form-group">
                  <label>Police Station</label>
                  <input type="text" name="ps" readonly="" class="form-control" value="<?php echo $data['station'];?>">
                </div>
                 <div class="form-group">
                  <label>Criminal Status</label>
                  <input type="text" name="cs" readonly="" class="form-control" value="<?php echo $data['criminal_status'];?>">
                  </div>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="mobile" readonly="" class="form-control" value="<?php echo $data['mobile_no'];?>">
                </div>
                <div class="form-group">
                  <label>Case</label>
                  <input type="text" name="case" readonly="" class="form-control" value="<?php echo $data['case_status'];?>">
                </div>
               <div class="form-group">
                  <label>Photo</label>
                  <img src="upload_criminal_images/<?php echo $data['photo'];?>" style="width: 200px;height: 150px;">
                </div>
                </div>
              <div class="col-md-3">
                <div class="form-group">
                  <label>CNIC</label>
                  <input type="text" name="cnic" readonly="" class="form-control" value="<?php echo $data['cnic'];?>">
                </div>
                <div class="form-group">
                  <label>Permanenet Address</label>
                  <input type="text" name="address" readonly="" class="form-control" value="<?php echo $data['address'];?>">
                </div>
                <div class="form-group">
                  <label>Case Date</label>
                  <input type="date" name="cd" readonly="" class="form-control" value="<?php echo $data['case_date'];?>">
                </div>
                <div class="form-group">
                  <label> Criminal Identity Mark</label>
                  <input type="text" name="im" readonly="" class="form-control" value="<?php echo $data['identity_mark'];?>">
                </div>
                <div class="form-group">
                  <label>Case Current Status</label>
                  <textarea name="ccs" class="form-control" readonly=""><?php echo $data['case_status'];?></textarea>
                </div>
              </div>
              <div class="col-md-2"></div>
            </div>
