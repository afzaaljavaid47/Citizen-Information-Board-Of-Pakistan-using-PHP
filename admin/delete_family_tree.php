       ...
       <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              ...
              <a href="delete_family_tree.php" class="dropdown-item active"><i class="fas fa-trash-alt"></i>Delete Record</a>
    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Delete Family Record </h1>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="fname" class="form-control" readonly="" value="<?php echo $data['father_name'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="fdob" class="form-control" readonly="" value="<?php echo $data['father_dob'];?>">
                </div>
                <div class="form-group">
                  <label>Fater Died Date (If Father Died)</label>
                  <input type="date" name="fdd" class="form-control" readonly="" value="<?php echo $data['father_dd'];?>">
                </div>  
                <div class="form-group">
                  <label>Family Address</label>
                  <input type="text" name="faddress" class="form-control" readonly="" value="<?php echo $data['family_address'];?>">
                </div>  
                </div>
              <div class="col-md-1"></div>
              ...
              <div class="col-md-4">
                  ...
                  <input type="text" name="mname" class="form-control" readonly="" value="<?php echo $data['mother_name'];?>">
                </div>
                <div class="form-group">
                  <label>Mother CNIC No. (Without Dashes)</label>
                  <input type="text" name="mcnic" class="form-control" readonly="" value="<?php echo $data['mother_cnic'];?>">
                </div>
                <div class="form-group">
                  <label>Mother D.O.B </label>
                  <input type="date" name="mdob" class="form-control" readonly="" value="<?php echo $data['mother_dob'];?>">
                </div>
                <div class="form-group">
                  <label>Mother Died Date (If Father Died)</label>
                  <input type="date" name="mdd" class="form-control" readonly="" placeholder="Sialkot....." value="<?php echo $data['mother_ddd'];?>">
                </div>
                            </div>
              <div class="col-md-2"></div>
            </div>
  ...
  while($data=mysqli_fetch_assoc($run))
    {
      ?>
          ...
          <tr>
            <td><input type="text" name="name" class="form-control" readonly="" value="<?php echo $data['name'];?>"></td>
            <td><input type="date" name="dob" class="form-control" readonly="" value="<?php echo $data['dob'];?>"></td>
            <td><input type="date" name="dod" class="form-control" readonly="" value="<?php echo $data['dd'];?>"></td>
            <td><input type="text" name="cnic" class="form-control" readonly="" value="<?php echo $data['cnic'];?>"></td>
            </tr>
          <?php
        }
    }
    ...
    ?>
        ...
        <center><br>
         <div class="form-group">
        <input type="submit" class="btn btn-lg btn-lg btn-primary" name="submit_delete" value="Delete Record" style="font-size: 18px;">
        </div>
          </center>
      </div>
  </div>
...
{
  $cnic=$_POST['fcnic'];
  $sql_fetch_cnic="DELETE FROM `family_tree_childs_info` WHERE `father_cnic`='$cnic'";
  $run=mysqli_query($con,$sql_fetch_cnic);
  $sql_fetch_cnic_parent="DELETE FROM `family_tree_parents_info` WHERE `father_cnic`='$cnic'";
  $run=mysqli_query($con,$sql_fetch_cnic_parent);
