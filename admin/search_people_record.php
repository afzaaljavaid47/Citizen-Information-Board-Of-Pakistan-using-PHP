       ...
       <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              ...
              <a href="search_people_record.php" class="dropdown-item active"><i class="fas fa-search"></i>Search Record</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Search People Record </h1>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="taddress" class="form-control" readonly="" value="<?php echo $data['temporary_address'];?>">
                </div>
                <div class="form-group">
                  <label>Photo</label>
                  <img src="upload_images/<?php echo $data['photo'];?>" readonly="" id="logo_preview" style="width: 200px;height: 150px;">
                </div>
                </div>
              <div class="col-md-3">
                <div class="form-group">
                  <label>CNIC</label>
                  <input type="text" name="cnic" readonly="" readonly="" class="form-control" value="<?php echo $data['person_cnic'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="paddress" class="form-control" readonly="" value="<?php echo $data['permanent_address'];?>">
                </div>
                <div class="form-group">
