        ...
        <div class="navbar-collapse-header d-md-none">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              <a href="add_people_record.php" class="dropdown-item active"><i class="fas fa-plus"></i>Add Record</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div style="background-color: #779eed;padding-top: 15px;padding-bottom: 50px;border-radius: 20px;color: white;">
            <h1 style="text-align: center;font-weight: bold;padding: 20px;color: white;">Add People Record</h1>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <textarea name="er" class="form-control"></textarea>
                </div>
              </div>
