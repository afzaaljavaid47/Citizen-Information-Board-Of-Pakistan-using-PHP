...
include("dbcon.php");
$id=$_GET['id'];
$sql="SELECT * FROM `criminal_record` WHERE `cnic`='$id'";
			...
			<a class="navbar-brand" href="index.html" style="font-weight: bold;color: #0c118a">CIBOP</a>	<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-wd" aria-controls="navbar-wd" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
						...
						<li><a class="nav-link" href="#team">Family Tree</a></li>
	...
	<tr>
		...
		<td style="padding: 50px;">
			<table>
				...
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Case  </b></span></td>
					<td><?php echo $data['jurm'];?></td>
				</tr>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Case Date  </b></span></td>
					<td><?php echo $data['case_date'];?></td>
				</tr>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Police Station</b></span></td>
					<td><?php echo $data['station'];?></td>
				</tr>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Criminal Status </b></span></td>
					<td><?php echo $data['criminal_status'];?></td>
				</tr>
				<tr>
					<td style="padding: 10px;"><span style="font-size: 18px;">	<b>Case Status  </b></span></td>
					<td><?php echo $data['case_status'];?></td>
				</tr>
				<tr>
					<td>
